...
fn find_next_word_start(graphemes: &[&str], start_col: usize) -> Option<usize> {
...
fn find_prev_word_start(graphemes: &[&str], start_col: usize) -> Option<usize> {
...
fn char_type(grapheme: &str) -> CharType {
