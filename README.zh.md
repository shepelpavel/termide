...
curl -LO https://github.com/termide/termide/releases/latest/download/termide-0.22.1-aarch64-apple-darwin.tar.gz
tar xzf termide-0.22.1-aarch64-apple-darwin.tar.gz
./termide
...
tar xzf termide-0.22.1-aarch64-unknown-linux-gnu.tar.gz
./termide

# Windows x86_64（从 Releases 下载 .zip，解压后在 Windows Terminal 中运行）
# https://github.com/termide/termide/releases/latest/download/termide-0.22.1-x86_64-pc-windows-msvc.zip
```
...
wget https://github.com/termide/termide/releases/latest/download/termide_0.22.1-1_amd64.deb
sudo dpkg -i termide_0.22.1-1_amd64.deb
```
...
```bash
# 仅限 x86_64（ARM64 请使用上面的 tar.gz）
wget https://github.com/termide/termide/releases/latest/download/termide-0.22.1-1.x86_64.rpm
sudo rpm -i termide-0.22.1-1.x86_64.rpm
```
