...
tar xzf termide-0.24.1-aarch64-unknown-linux-gnu.tar.gz
./termide
...
# https://github.com/termide/termide/releases/latest/download/termide-0.24.1-x86_64-pc-windows-msvc.zip
```
