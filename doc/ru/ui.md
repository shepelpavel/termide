...
- `Git` открывает панель статуса git
- `Журнал` открывает панель логов
- `Сессии` управление сессиями (сохранение, восстановление, удаление)
- `Окна` управление панелями
- `Скрипты` пользовательские скрипты
- `Закладки` сохранённые местоположения
- `Опции` темы, настройки языка
