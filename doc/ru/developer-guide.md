...
│   ├── layout/               # Компоновка панелей и система аккордеона
...
│   ├── theme/                # Система тем и 24 встроенные темы
...
- Управляет горизонтальными группами панелей (`Vec<PanelGroup>`)
- Обрабатывает навигацию фокуса (Alt+Left/Right между группами)
...
- `width: Option<u16>` для явного контроля ширины
- Обеспечивает навигацию внутри группы (Alt+Up/Down)
